<?php 
/**
 * @package WC_EMAIL_CONFIRMATION
 * @version 0.0.1
 */
/*
Plugin Name: WC Email Confirmation
Description: This Plugin is used to confirm Email Id used by Users while register by sending activation link to Customer Email
Author: Sreeraj Nair
Version: 0.0.1
Author URI: http://iamsreerajnair.github.io/
*/
...
function wc_registration_redirect( $redirect_to ) {     // prevents the user from logging in automatically after registering their account
    wp_logout();
    $url =get_site_url();
    wp_redirect( '/dgbusiness/verify/?n=');                        // redirects to a confirmation message
    exit;
}
